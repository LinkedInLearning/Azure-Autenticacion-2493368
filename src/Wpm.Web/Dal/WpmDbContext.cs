...
public class WpmDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Pet>().HasData(
                    new Pet() { Id = 1, Name = "Gianni", Age = 10, Weight = 19, PhotoUrl= "https://wpmazurestorageaccount.blob.core.windows.net/photos/gianni.jpg", BreedId = 1 },
                    new Pet() { Id = 2, Name = "Nina", Age = 8, Weight = 24, PhotoUrl = "https://wpmazurestorageaccount.blob.core.windows.net/photos/nina.jpg", BreedId = 1 },
                    new Pet() { Id = 3, Name = "Cati", Age = 8, Weight = 33.5m, PhotoUrl = "https://wpmazurestorageaccount.blob.core.windows.net/photos/cati.jpg", BreedId = 2 },
